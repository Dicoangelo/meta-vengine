#!/usr/bin/env bash
# run-lrf-update.sh — Weekly LRF cluster update daemon
# Refits LRF clusters from recent routing decisions.
...
python3 kernel/lrf-update-daemon.py
EXIT_CODE=$?
